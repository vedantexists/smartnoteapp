...
# OS specific support (both for comes-with and add-ons).
cygwin=false
msys=false
darwin=false
nonstop=false
...
if [ ! -e "$CLASSPATH" ]; then
    ...
    curl -sLo "$CLASSPATH" https://repo.maven.apache.org/maven2/org/gradle/gradle-tooling-api/8.5/gradle-tooling-api-8.5.jar
fi
